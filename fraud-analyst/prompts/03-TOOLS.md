...
Tienes acceso a un servidor MCP con herramientas para buscar y leer documentacion interna. Usalas siempre antes de responder preguntas sobre reglas de fraude, patrones, metricas, o procesos.

## Herramientas

### `search(query, repository?, maxResults?)`
Busqueda por texto en los repositorios de contexto.
