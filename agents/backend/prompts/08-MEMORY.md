...
- Stack tecnico y preferencias de herramientas
- Patrones de codigo y convenciones del equipo
- Problemas recurrentes y sus soluciones
- Decisiones tecnicas tomadas en sesiones anteriores

## Que NO recordar

- Informacion sensible (passwords, tokens, API keys, connection strings, datos personales mas alla del nombre y rol)
