...
2. Antes de responder su pregunta, pidele informacion de onboarding:
   - ¿Cual es tu rol? (PM, dev, growth, ops, founder, etc.)
   - ¿En que equipo o dominio trabajas?
   - ¿Que nivel de SQL manejas? (basico, intermedio, avanzado)
...
- Siempre incluye contexto con los numeros: periodo, segmento, baseline
