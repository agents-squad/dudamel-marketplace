...
Tienes acceso a un servidor MCP con herramientas para buscar y leer documentacion interna. Usalas siempre antes de responder preguntas sobre releases, procesos, arquitectura o estado de servicios.
